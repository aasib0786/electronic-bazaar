      ...
      // ]
         const ShowProductSlider=()=>{
           return (data.map((item)=>{
               return(
              <div style={{display:'flex', marginBottom:'4%' ,borderBottom:'1px solid #353535'}}>
                 <div style={{width:'50%',display:'flex' ,justifyContent:'center'}}>
                     <img src={`${serverURL}/images/${item.picture}` } style={{width:'65%'   }}/>
                   </div>
                   <div style={{flexDirection:'column', width:'50%'}}>
                     <div style={{color:'#fff',display:'flex',fontSize:'2vw' }}> 
                      ...
                      <dib style={{border:'1px solid #ff02B9' ,color:'#ff02B9' ,fontSize:'1vw', justifyContent:'center' , display:'flex', width:'35%',borderRadius:'5%' }} >
                        <span style={{ fontWeight:'bold' ,fontSize:'70%',margin:'2%'}}>5000 off on pymant page</span>
                      </dib>
                      <dib style={{border:'1px solid #ff02B9' ,color:'#ff02B9' ,fontSize:'1vw',marginLeft:'2%', justifyContent:'center' , display:'flex', width:'20%',borderRadius:'5%' }} >
                        <span style={{ fontWeight:'bold' ,fontSize:'70%',margin:'2%'}}>Best Saller</span>
                      </dib>
                      </div>
                      <div style={{ marginTop:'1.5%',fontSize:'1.8vw'}}>
                             &#x20b9;{item.offerprice}
                             <div  style={{ marginTop:'-1%',fontSize:'0.8vw'}} >(Incl. all Taxes)</div> 
                      </div>
                      ...
                      <div style={{marginTop:'5%',display:'flex'}}>
                        <PlaceIcon/>
                        <span style={{fontSize:'0.8vw', marginBottom:'2%'}} >Delivery at:<b style={{color:'#12DAA8',borderBottom:'0.5px solid #12DAA8'}}> Mumbai, 400049</b>
<div style={{marginTop:'2%'}}>Standard Delivery by Tomorrow</div> </span>
                       </div>
                       
                      </div>
                      <div style={{color:"#fff",marginLeft:'auto' , position:'initial',padding:'1%',color:'green', onMouseLeave:'white' ,onMouseEnter:'red' }}>
                  <FavoriteBorderIcon/>
                </div>
       ...
       return(<div style={{width:'80%' , flexDirection:'column',marginTop:'4%'}}>
              {ShowProductSlider()}
